...
public class GameBoardSixPlayersController {
	...
	public void populatePurple() {
		...
		crcBeginPurple4.setFill(new ImagePattern(im6));
	}
	
	/**
	 * Methode, welche die blauen Spielfiguren belebt
	 */
	public void populateBlue() {
		...
		crcBeginBlue4.setFill(new ImagePattern(im5));
	}
